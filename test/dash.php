    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto">
                <h1 class="sitename"><img src="../img/code.png" alt="">groupfolio</h1>
            </a>
    ...
    <main class="main">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
                        ...
                        <div class="d-flex">
                            ...
                            <!-- <a href="https://youtu.be/dQw4w9WgXcQ?si=oU5aV7G4WPbjKp8z" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a> -->
                        </div>
                    </div>
                    <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="100">
                        <!-- <img src="../img/hahaha.png" class="img-fluid animated" alt=""> -->
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="about section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <h2>About</h2>
                <p>We are a dynamic group of passionate individuals united by our commitment to creativity, innovation, and collaboration. As students and aspiring professionals, we bring together diverse skills and talents, including application development, design, artistry, and technology.</p>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
                        <img src="../img/group.jpg" class="img-fluid" alt="">
